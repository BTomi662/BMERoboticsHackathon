...
def convertToGameBoard(coordinates):
    """Convert camera detections into a GameBoard instance."""
    camera_state = convertToMisiFormat(coordinates)
    return GameBoard.from_camera_state(camera_state)
    ...
    for chunk in stream.iter_content(chunk_size=1024):
        ...
        if a != -1 and b != -1:
            ...
            if calibrated:
                ...
                if players:
                    output = convertToGameBoard(players)
